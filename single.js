  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExample" data-bs-slide="next">
    ...
    <span class="visually-hidden">Next</span>
            ...
            <div class="col-md-5">
                ...
                <h4>Size </h4>
                <button id="size-btn1" onclick="highlight(this)" class="btn btn-white btn-sm border-2 border-dark-subtle me-2 my-btn-is-active">${singleproduct.size}</button>
                <button id="size-btn2" onclick="highlight(this)" class="btn btn-white btn-sm border-2 border-dark-subtle me-2 my-btn-is-active">${singleproduct.size2}</button><br><br>
                <button onclick="download()" class="btn btn-primary btn-lg">Download-PDF</button>

            </div>`
function highlight(clickedButton){
            const btn=document.getElementById('size-btn1').classList.remove('active2')
            const btn2=document.getElementById('size-btn2').classList.remove('active2')
